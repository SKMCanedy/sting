...
router.post("/", jsonParser, (req, res) => {
    ...
    const userSchema = {
        ...
        password: Joi.string().min(3).max(72).regex(/^[A-Za-z0-9_!@$]+$/).required()//allows _ ! @ $ as special characters. pw min length would be increased in prod. keeping short for demo
};
